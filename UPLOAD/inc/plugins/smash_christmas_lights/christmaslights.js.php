...
soundManager.url = '<?php echo $bburl;?>/inc/plugins/smash_christmas_lights/';
...
function XLSF(oTarget,urlBase) {
  ...
  var urlBase = '<?php echo $bburl;?>/inc/plugins/smash_christmas_lights/';
  writeDebug('XLSF()');
  ...
  this.lightClass = (screenX>1280?'<?php echo $light_size;?>':'pico'); // kind of light to show (32px to 96px square)
